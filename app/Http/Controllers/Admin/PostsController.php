...
class PostsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('comum.posts.index', compact('posts'));
    }
    ...
    {
        return view('comum.posts.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('comum.posts.show', compact('post'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('comum.posts.edit', compact('post'));
    }
